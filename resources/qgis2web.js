...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [638811.086800, 9576161.325100, 666563.636000, 9594619.016100], maxZoom: 25, minZoom: 6, projection: new ol.proj.Projection({
            code: 'EPSG:32717',
            //extent: [638811.086800, 9576161.325100, 666563.636000, 9594619.016100],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([638811.086800, 9576161.325100, 666563.636000, 9594619.016100], map.getSize());
